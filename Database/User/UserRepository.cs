...
namespace Architecture.Database
{
    public sealed class UserRepository : EFRepository<User>, IUserRepository
    {
        ...
        public Task<UserModel> GetUserByAuthIdAsync(long id)
        {
            return Queryable.Where(UserExpression.AuthIdExpression(id)).Select(UserExpression.Model).SingleOrDefaultAsync();
        }
